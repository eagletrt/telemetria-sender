...
static MunitResult test_log_debug(const MunitParameter params[], void* fixture);
static void test_log_debug_tear_down(void* fixture);

/* EXPORTED SUITE */

static MunitTest tests_log_debug[] = {
  {
    "",
    test_log_debug,
    test_log_debug_setup,
    NULL,
    MUNIT_TEST_OPTION_NONE,
    test_log_debug_params
  },
  { NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL }
};

static MunitSuite log_utils_log_debug_suite = {
  "/log-debug",
  tests_log_debug,
  NULL,
  1,
...
MunitSuite* get_log_utils_log_debug_suite() {
  return &log_utils_log_debug_suite;
}
...
static void* test_log_debug_setup(const MunitParameter params[], void* user_data) {
    test_log_debug_fixture* fixture = (test_log_debug_fixture*) malloc(sizeof(test_log_debug_fixture));

    const int MAX_SIZE = 1000;
    fixture->str = strdup(params[0].value);
    fixture->expected = (char*) malloc(MAX_SIZE * sizeof(char));
    sprintf(fixture->expected, "\e[1;30m[DEBUG]\x1b[0m\t\t%s\n", fixture->str);

    return (void*) fixture;
}
static MunitResult test_log_debug(const MunitParameter params[], void* fixture) {
    test_log_debug_fixture* typed_fixture = (test_log_debug_fixture*) fixture;
